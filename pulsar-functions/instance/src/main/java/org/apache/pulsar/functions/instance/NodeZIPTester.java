...
public class NodeZIPTester {
    ...
    public static void main(String[] args) throws PulsarClientException {
        ...
        instanceConfig.setFunctionId("test-zip");
        ...
        sourceSpecBuilder.putInputSpecs("persistent://public/default/test-node-package-zip-source", Function.ConsumerSpec.newBuilder().setIsRegexPattern(false).build());
        ...
        sinkSpecBuilder.setTopic("persistent://public/default/test-node-package-zip-sink");
        ...
        functionDetailsBuilder.setName("test-node-zip");

        functionDetailsBuilder.setRuntime(Function.FunctionDetails.Runtime.NODEJS);
        functionDetailsBuilder.setClassName("http");
