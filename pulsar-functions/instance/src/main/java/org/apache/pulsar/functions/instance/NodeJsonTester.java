...
public class NodeJsonTester {
    ...
    public static void main(String[] args) throws PulsarClientException {
        ...
        instanceConfig.setFunctionId("test-node-json");
        ...
        sourceSpecBuilder.putInputSpecs("persistent://public/default/test-node-package-json-source", Function.ConsumerSpec.newBuilder().setIsRegexPattern(false).setSchemaType("json").build());
        ...
        sinkSpecBuilder.setTopic("persistent://public/default/test-node-package-json-sink");
        ...
        functionDetailsBuilder.setName("test-node-json");
