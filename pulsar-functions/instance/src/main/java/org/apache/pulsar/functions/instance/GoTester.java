...
public class GoTester {
    ...
    public static void main(String[] args) throws PulsarClientException {
        ...
        sourceSpecBuilder.putInputSpecs("persistent://public/default/test-go-package-source", Function.ConsumerSpec.newBuilder().setIsRegexPattern(false).build());
        ...
        sinkSpecBuilder.setTopic("persistent://public/default/test-go-package-sink");
        ...
        functionDetailsBuilder.setName("test-go-package");

        functionDetailsBuilder.setRuntime(Function.FunctionDetails.Runtime.GO);
        functionDetailsBuilder.setClassName("main");
