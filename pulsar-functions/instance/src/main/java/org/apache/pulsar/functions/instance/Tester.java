...
public class Tester {
    ...
    public static void main(String[] args) throws PulsarClientException {
        ...
        sourceSpecBuilder.putInputSpecs("persistent://public/default/test-py-package-source", Function.ConsumerSpec.newBuilder().setIsRegexPattern(false).build());
        ...
        sinkSpecBuilder.setTopic("persistent://public/default/test-py-package-sink");
        ...
        functionDetailsBuilder.setClassName("exclamation_function.ExclamationFunction");
